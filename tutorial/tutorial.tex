...
\section{Part 1 --- IBS: looking at identity windows}
...
for this cohort? \emph{Hint: count the related pairs in the
inter-individual class.}
\end{quest}
...
\begin{itemize}\setlength{\itemsep}{0.2em}
  ...
  \item \texttt{--min-lod}: minimum LOD score
    ($\log_{10} P(\text{data}|\text{IBD}) / P(\text{data}|\neg\text{IBD})$).
...
\section{Part 3 --- Local ancestry inference}
...
\begin{itemize}\setlength{\itemsep}{0.2em}
  \item \texttt{--auto-configure}: estimates the softmax temperature
    of the emission model and the pairwise-contrast weight directly from
    the data. Implies pairwise emissions and parameter estimation.
...
\section{Part 4 --- Grandparent painting of the CEPH pedigree}
